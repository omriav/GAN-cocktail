...
def project(
    ...
    *,
    ...
    label = F.one_hot(torch.tensor(init_class), G.c_dim).unsqueeze(0).to(device)
    label = label.repeat(w_avg_samples, 1)
...
@click.option('--init-class',             help='The class for the initial guess', type=int, default=0)
...
@click.option('--use-w-plus',             help='Embed to W+ space', type=bool, default=False)
